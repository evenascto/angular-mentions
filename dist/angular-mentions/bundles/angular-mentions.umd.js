(function (global, factory) {
    ...
    function MentionListComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
        ...
        core.ɵɵtextInterpolate1(" ", item_r4[ctx_r1.labelKey], " ");
    } }
    ...
    function MentionListComponent_li_4_Template(rf, ctx) { if (rf & 1) {
        ...
        core.ɵɵelementStart(1, "a", 4);
        core.ɵɵlistener("mousedown", function MentionListComponent_li_4_Template_a_mousedown_1_listener($event) { core.ɵɵrestoreView(_r9); var i_r6 = ctx.index; var ctx_r8 = core.ɵɵnextContext(); ctx_r8.activeIndex = i_r6; ctx_r8.itemClick.emit(); return $event.preventDefault(); });
        core.ɵɵtemplate(2, MentionListComponent_li_4_ng_template_2_Template, 0, 0, "ng-template", 5);
        core.ɵɵelementEnd();
        core.ɵɵelementEnd();
    } if (rf & 2) {
        ...
        core.ɵɵclassProp("active", ctx_r3.activeIndex == i_r6)("mention-active", !ctx_r3.styleOff && ctx_r3.activeIndex == i_r6);
        core.ɵɵadvance(1);
        core.ɵɵclassProp("mention-item", !ctx_r3.styleOff);
        core.ɵɵadvance(1);
        core.ɵɵproperty("ngTemplateOutlet", ctx_r3.itemTemplate)("ngTemplateOutletContext", core.ɵɵpureFunction1(8, _c2, item_r5));
    } }
    /**
     * Angular Mentions.
    ...
    var MentionListComponent = /** @class */ (function () {
        ...
        MentionListComponent.ɵfac = function MentionListComponent_Factory(t) { return new (t || MentionListComponent)(core.ɵɵdirectiveInject(core.ElementRef)); };
        MentionListComponent.ɵcmp = core.ɵɵdefineComponent({ type: MentionListComponent, selectors: [["mention-list"]], viewQuery: function MentionListComponent_Query(rf, ctx) { if (rf & 1) {
                core.ɵɵstaticViewQuery(_c0, true);
                core.ɵɵstaticViewQuery(_c1, true);
            } if (rf & 2) {
                var _t;
                core.ɵɵqueryRefresh(_t = core.ɵɵloadQuery()) && (ctx.list = _t.first);
                core.ɵɵqueryRefresh(_t = core.ɵɵloadQuery()) && (ctx.defaultItemTemplate = _t.first);
                ...
                core.ɵɵtemplate(0, MentionListComponent_ng_template_0_Template, 1, 1, "ng-template", null, 0, core.ɵɵtemplateRefExtractor);
                core.ɵɵelementStart(2, "ul", 1, 2);
                core.ɵɵtemplate(4, MentionListComponent_li_4_Template, 3, 10, "li", 3);
                core.ɵɵelementEnd();
            } if (rf & 2) {
                core.ɵɵadvance(2);
                core.ɵɵclassProp("mention-menu", !ctx.styleOff)("mention-dropdown", !ctx.styleOff && ctx.dropUp);
                core.ɵɵproperty("hidden", ctx.hidden);
                core.ɵɵadvance(2);
                core.ɵɵproperty("ngForOf", ctx.items);
            } }, directives: [common.NgForOf, common.NgTemplateOutlet], styles: [".mention-menu[_ngcontent-%COMP%]{position:absolute;top:100%;left:0;z-index:1000;display:none;float:left;min-width:11em;padding:.5em 0;margin:.125em 0 0;font-size:1em;color:#212529;text-align:left;list-style:none;background-color:#fff;background-clip:padding-box;border:1px solid rgba(0,0,0,.15);border-radius:.25em}.mention-item[_ngcontent-%COMP%]{display:block;padding:.2em 1.5em;line-height:1.5em;clear:both;font-weight:400;color:#212529;text-align:inherit;white-space:nowrap;background-color:transparent;border:0}.mention-active[_ngcontent-%COMP%] > a[_ngcontent-%COMP%]{color:#fff;text-decoration:none;background-color:#337ab7;outline:0}.scrollable-menu[_ngcontent-%COMP%]{display:block;height:auto;max-height:292px;overflow:auto}[hidden][_ngcontent-%COMP%]{display:none}.mention-dropdown[_ngcontent-%COMP%]{bottom:100%;top:auto;margin-bottom:2px}"] });
        return MentionListComponent;
    }());
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(MentionListComponent, [{
            type: core.Component,
            args: [{
        ...
        }], function () { return [{ type: core.ElementRef }]; }, { labelKey: [{
                type: core.Input
            }], itemTemplate: [{
                type: core.Input
            }], itemClick: [{
    ...
    var MentionDirective = /** @class */ (function () {
        ...
        MentionDirective.ɵfac = function MentionDirective_Factory(t) { return new (t || MentionDirective)(core.ɵɵdirectiveInject(core.ElementRef), core.ɵɵdirectiveInject(core.ComponentFactoryResolver), core.ɵɵdirectiveInject(core.ViewContainerRef)); };
        MentionDirective.ɵdir = core.ɵɵdefineDirective({ type: MentionDirective, selectors: [["", "mention", ""], ["", "mentionConfig", ""]], hostAttrs: ["autocomplete", "off"], hostBindings: function MentionDirective_HostBindings(rf, ctx) { if (rf & 1) {
                core.ɵɵlistener("keydown", function MentionDirective_keydown_HostBindingHandler($event) { return ctx.keyHandler($event); })("input", function MentionDirective_input_HostBindingHandler($event) { return ctx.inputHandler($event); })("blur", function MentionDirective_blur_HostBindingHandler($event) { return ctx.blurHandler($event); });
            } }, inputs: { mention: "mention", mentionConfig: "mentionConfig", mentionListTemplate: "mentionListTemplate" }, outputs: { searchTerm: "searchTerm", itemSelected: "itemSelected", opened: "opened", closed: "closed" }, features: [core.ɵɵNgOnChangesFeature] });
        return MentionDirective;
    }());
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(MentionDirective, [{
            type: core.Directive,
            args: [{
        ...
        }], function () { return [{ type: core.ElementRef }, { type: core.ComponentFactoryResolver }, { type: core.ViewContainerRef }]; }, { mention: [{
                type: core.Input,
                args: ['mention']
            }], mentionConfig: [{
                type: core.Input
    ...
    var MentionModule = /** @class */ (function () {
        ...
        MentionModule.ɵmod = core.ɵɵdefineNgModule({ type: MentionModule });
        MentionModule.ɵinj = core.ɵɵdefineInjector({ factory: function MentionModule_Factory(t) { return new (t || MentionModule)(); }, imports: [[
                    common.CommonModule
                ]] });
        return MentionModule;
    }());
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && core.ɵɵsetNgModuleScope(MentionModule, { declarations: [MentionDirective,
            MentionListComponent], imports: [common.CommonModule], exports: [MentionDirective] }); })();
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(MentionModule, [{
            type: core.NgModule,
            args: [{
                    declarations: [
                        MentionDirective,
