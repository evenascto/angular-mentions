...
export declare function insertValue(el: HTMLInputElement, start: number, end: number, insertHTML: boolean, text: any, iframe: HTMLIFrameElement, noRecursion?: boolean): void;
